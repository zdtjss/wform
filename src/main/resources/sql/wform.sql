...
CREATE TABLE `T_FORM_PAGE_FIELD_LIST`  (
  ...
  IS_KEY INT(1) NULL DEFAULT NULL,
  PRIMARY KEY (`PK_ID`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO T_FORM_PAGE_FIELD_FORM VALUES('2','1001','2',2,1,1,1,0);
INSERT INTO T_FORM_PAGE_FIELD_FORM VALUES('3','1001','3',2,2,1,1,0);
...
INSERT INTO `T_FORM_PAGE` VALUES ('1002', 'first_list', '第一个列表页', 'list', 0,'t_auto_1001','测试', '100101', '2017-12-16 20:14:52', '2017-12-16 20:14:54', 1);
